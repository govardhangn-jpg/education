...
const userSchema = new mongoose.Schema({
  ...
  grade: { type: String, enum: ['Class 1','Class 2','Class 3','Class 4','Class 5','Class 6','Class 7','Class 8','Class 9','Class 10'], required: true },
  syllabus: { type: String, enum: ['CBSE', 'ICSE', 'Karnataka State'], required: true },
